...
namespace ViewModel.M.主管資訊
{
    public class 客戶資料查詢ViewModel : INotifyPropertyChanged
    {
        ...
        public 客戶資料查詢ViewModel()
        {
            _客戶代號 = "";
            _起始品號 = "";
            _截止訂單 = "zzzz";
            _截止品號 = "zzzz";
            _起始日期 = DateTime.Now.AddMonths(-1).ToString("yyyyMMdd");
            _截止日期 = DateTime.Now.ToString("yyyyMMdd");
        }
        public string 客戶代號
        {
            get
        ...
        private DataSet 訂單查詢()
        {
            ...
            DataSet ds = 邏輯Bll.M.主管資訊.主管資訊查詢.客戶資料訂單查詢( 查詢條件, 查詢欄位);
            return ds;
        }
        private DataSet 出貨查詢()
        {
            ...
            DataSet ds = 邏輯Bll.M.主管資訊.主管資訊查詢.客戶資料出貨查詢( 查詢條件, 查詢欄位);
            return ds;
        }
