...
namespace ViewModel
{
    public class Dept_1ViewModel : INotifyPropertyChanged
    {
        ...
        public string 序號
        {
            get { if (dept_1Model.序號 == null) { dept_1Model.序號 = ""; } return dept_1Model.序號; }
            set { dept_1Model.序號 = value; OnPropertyChanged("序號"); }
        }
        ...
        public string 姓名
        {
            get { if (dept_1Model.姓名 == null) { dept_1Model.姓名 = ""; } return dept_1Model.姓名; }
            set
            {
                dept_1Model.姓名 = value;
